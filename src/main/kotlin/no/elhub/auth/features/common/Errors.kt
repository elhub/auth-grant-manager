...
fun toDeserializationApiErrorResponse(): Pair<HttpStatusCode, JsonApiErrorCollection> =
...
fun toBalanceSupplierNotApiAuthorizedResponse(): Pair<HttpStatusCode, JsonApiErrorCollection> =
    buildApiErrorResponse(
