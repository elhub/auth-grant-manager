...
typealias HttpScopesResponseBody = JsonApiResponse.CollectionDocument<AuthorizationGrantScopeAttributes>

fun List<AuthorizationScope>.toResponseBody(): HttpScopesResponseBody =
    HttpScopesResponseBody(
