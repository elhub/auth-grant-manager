...
fun fontSupplier(bytes: ByteArray): FSSupplier<InputStream> =
...
private fun PdfRendererBuilder.useFonts(fonts: List<FontDef>): PdfRendererBuilder {
    fonts.forEach { font ->
        this.useFont(fontSupplier(font.bytes), font.family, font.weight, font.style, true)
    }
    return this
}
