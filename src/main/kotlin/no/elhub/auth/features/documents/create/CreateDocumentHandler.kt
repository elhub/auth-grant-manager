...
import no.elhub.auth.features.documents.create.CreateDocumentCommand
...
class CreateDocumentHandler(
    ...
    suspend operator fun invoke(command: CreateDocumentCommand): AuthorizationDocument {
        ...
        val authorizationDocument = command.getModel(signedPdf)
        repo.insert(authorizationDocument)
        return authorizationDocument
    }
}

fun CreateDocumentCommand.getModel(pdfBytes: ByteArray) =
