...
interface DocumentRepository {
    fun find(id: UUID): Either<DocumentRepositoryProblem, AuthorizationDocument>
    fun insert(doc: AuthorizationDocument)
    fun findAll(): List<AuthorizationDocument>
}
...
class ExposedDocumentRepository : DocumentRepository {
    ...
    override fun find(id: UUID): Either<DocumentRepositoryProblem, AuthorizationDocument> = transaction {
        ...
        try {
            ...
            DocumentRepositoryProblem.UnexpectedError.left()
        }
    }
