...
import no.elhub.auth.v1.features.documents.create.CreateDocumentCoreHandler
...
fun Application.module() {
    ...
    dependencies {
        provide<CreateDocumentCoreHandler> { CreateDocumentCoreHandler() }
        provide<CreateDocumentBusinessHandler> { CreateDocumentBusinessHandler(resolve()) }
