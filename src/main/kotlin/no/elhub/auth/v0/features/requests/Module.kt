...
import no.elhub.auth.v0.features.requests.common.ExposedRequestPropertiesRepository
import no.elhub.auth.v0.features.requests.common.ExposedRequestRepository
...
import no.elhub.auth.v0.features.requests.get.route as getRoute
import no.elhub.auth.v0.features.requests.query.Handler as QueryHandler
import no.elhub.auth.v0.features.requests.query.route as queryRoute
import no.elhub.auth.v0.features.requests.update.Handler as UpdateHandler
import no.elhub.auth.v0.features.requests.update.route as updateRoute
