package no.elhub.auth.v0.features.requests.query.dto

import kotlinx.serialization.json.buildJsonObject
import kotlinx.serialization.json.put
import no.elhub.auth.v0.features.common.Page
import no.elhub.auth.v0.features.common.currentTimeOslo
import no.elhub.auth.v0.features.common.dto.JsonApiResourceMetaMap
import no.elhub.auth.v0.features.common.dto.PaginatedCollectionResponse
import no.elhub.auth.v0.features.common.party.dto.toJsonApiRelationship
import no.elhub.auth.v0.features.common.toPaginationLinks
import no.elhub.auth.v0.features.common.toTimeZoneOffsetString
import no.elhub.auth.v0.features.grants.GRANTS_PATH
import no.elhub.auth.v0.features.requests.AuthorizationRequest
import no.elhub.auth.v0.features.requests.REQUESTS_PATH
import no.elhub.auth.v0.features.requests.common.dto.AuthorizationRequestResponseAttributes
import no.elhub.auth.v0.features.requests.common.dto.AuthorizationRequestResponseLinks
import no.elhub.auth.v0.features.requests.common.dto.AuthorizationRequestResponseRelationships
