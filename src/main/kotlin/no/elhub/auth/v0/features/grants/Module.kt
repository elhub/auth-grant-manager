...
import no.elhub.auth.v0.features.grants.get.route as getRoute
import no.elhub.auth.v0.features.grants.getscopes.Handler as GetScopesHandler
import no.elhub.auth.v0.features.grants.getscopes.route as getScopesRoute
import no.elhub.auth.v0.features.grants.query.Handler as QueryHandler
import no.elhub.auth.v0.features.grants.query.route as queryRoute
