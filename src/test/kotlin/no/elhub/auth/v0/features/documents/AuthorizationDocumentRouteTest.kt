...
import no.elhub.auth.v0.features.common.AuthPersonsTestContainerExtension
import no.elhub.auth.v0.features.common.CreateScopeData
import no.elhub.auth.v0.features.common.PdpTestContainerExtension
...
import no.elhub.auth.v0.features.common.currentTimeOslo
...
import no.elhub.auth.v0.features.documents.create.dto.CreateDocumentMeta
import no.elhub.auth.v0.features.documents.create.dto.CreateDocumentRequestAttributes
import no.elhub.auth.v0.features.documents.create.dto.CreateDocumentResponse
import no.elhub.auth.v0.features.documents.create.dto.JsonApiCreateDocumentRequest
...
import no.elhub.auth.v0.features.documents.get.dto.GetDocumentSingleResponse
import no.elhub.auth.v0.features.documents.query.dto.GetDocumentCollectionResponse
import no.elhub.auth.v0.features.grants.AuthorizationScope
import no.elhub.auth.v0.features.grants.GRANTS_PATH
import no.elhub.auth.v0.features.grants.common.CreateGrantProperties
import no.elhub.auth.v0.features.grants.common.dto.AuthorizationGrantScopesResponse
import no.elhub.auth.v0.features.grants.common.dto.SingleGrantResponse
import no.elhub.auth.v0.shouldBeValidUuid
