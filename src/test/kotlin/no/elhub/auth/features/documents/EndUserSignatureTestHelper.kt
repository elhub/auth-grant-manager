...
class EndUserSignatureTestHelper(
    ...
    fun sign(
        ...
        val certificate =
            certFactory.generateLeafCertificateWithNationalId(
                keyPair = keyPair,
    ...
    fun signWithUntrustedCertificate(
        ...
        val selfSignedRoot =
            certFactory.generateSelfSignedRootCertificate(
                keyPair = rootKeyPair,
    ...
    fun signWithoutNationalIdExtension(pdfBytes: ByteArray): ByteArray {
        val keyPair = certFactory.generateKeyPair()
        val certificate =
            certFactory.generateLeafCertificateWithoutNationalId(
                keyPair = keyPair,
                issuerKeyPair = rootKeyPair,
                issuerCertificate = rootCertificate,
            )
