...
import io.kotest.core.spec.style.BehaviorSpec as BehaviourSpec // Rule Britannia, Britannia rules the waves....
 ...
 */
class CreateDocumentTest : BehaviourSpec(), KoinTest {
    init {
        beforeSpec {
            startKoin {
                modules(
                    module {
                        ...
                        singleOf(::VaultSignatureProvider)
                        singleOf(::DssSigningService) bind SigningService::class
            ...
            Given("that no pending documents already exist for the customer") {
                ...
                And("that the customer exists") {
                    ...
                    When("I request a document") {
                        ...
                        Then("The file should include Elhub's signature") {
                            document.pdfBytes.getSignature() shouldBe elhubSignature
                        }

                        Then("The file metadata should include the customer's social security number") {
