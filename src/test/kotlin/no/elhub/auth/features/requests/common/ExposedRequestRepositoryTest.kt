...
class ExposedRequestRepositoryTest :
    FunSpec({
        extensions(
        ...
        test("confirm authorization request with properties") {
            ...
            val acceptedRequest =
                transaction {
                    ...
                    requestRepo
                        .acceptRequest(savedRequest.id, AuthorizationParty("resourceId1", PartyType.Organization))
                        .getOrElse {
        ...
        test("confirm authorization request without properties") {
            ...
            transaction {
                val insertedRequest =
                    requestRepo
                        .insert(requestToConfirm, scopes)
                        .getOrElse { error ->
