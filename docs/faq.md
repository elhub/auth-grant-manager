...
The recommended way to test the business processes for ChangeOfBalanceSupplierForPerson and MoveInAndChangeOfBalanceSupplierForPerson is
...
## Market Process Specific Questions: ChangeOfBalanceSupplierForPerson and MoveInAndChangeOfBalanceSupplierForPerson
...
and BRS-NO-103). ChangeOfBalanceSupplierForPerson is used for BRS-NO-101, while MoveInAndChangeOfBalanceSupplierForPerson is
...
* **requestedFrom**: We validate that the entity is the end user of the metering point when the message type is
    "ChangeOfBalanceSupplierForPerson". The opposite is checked for "MoveInAndChangeOfBalanceSupplierForPerson".
